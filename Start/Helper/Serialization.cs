...
namespace HYProject.Helper
{
    ...
    public class Serialization
    {
        ...
        {
            FileStream stream = new FileStream(System.Windows.Forms.Application.StartupPath + "\\Data\\" + name + ".bin", FileMode.Create);
            BinaryFormatter bFormat = new BinaryFormatter();
            bFormat.Serialize(stream, obj);
            stream.Close();
        }
        ...
        {
            if (File.Exists(System.Windows.Forms.Application.StartupPath + "\\Data\\" + name + ".bin"))
            {
                FileStream stream = new FileStream(System.Windows.Forms.Application.StartupPath + "\\Data\\" + name + ".bin", FileMode.Open);
                BinaryFormatter bFormat = new BinaryFormatter();
