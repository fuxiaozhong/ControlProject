...
{
    public partial class Form_OldLog : ToolKit.HYControls.HYForm.HYBaseForm
    {
        public Form_OldLog()
        {
            InitializeComponent();
        ...
        private void ListBox1_DoubleClick(object sender, EventArgs e)
        {
            if (!test)
            {
                Task.Run(() => {
                    test = true;
                    HYForm_Waiting hYForm_Waiting = new HYForm_Waiting(Loading);
                    hYForm_Waiting.ShowDialog();
                });
            }
        ...
        private void Loading(object sender, EventArgs e)
        {
            this.Invoke(new Action(delegate
            {
                ...
                this.dataGridView1.Columns[0].FillWeight = 150F;
                ...
                this.dataGridView1.Columns[1].FillWeight = 150F;
                this.dataGridView1.Columns[1].Width = 80;
                // 
                // Column3
                // 
                this.dataGridView1.Columns[2].AutoSizeMode = System.Windows.Forms.DataGridViewAutoSizeColumnMode.None;
                this.dataGridView1.Columns[2].FillWeight = 21.2766F;
                this.dataGridView1.Columns[2].Width = 600;
                test = false;
            }));
        }
