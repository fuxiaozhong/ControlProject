...
namespace HYProject
{
    public partial class MainForm : HYBaseForm
    {
        ...
        private void MainForm_Load(object sender, EventArgs e)
        {
            ...
            tabPage1.Controls.Add(Form_Offset.Instance);
            tabPage2.Controls.Add(Form_General_Parameters.Instance);
            ...
            try
            {
                DisplayForm.Instance.DisplayWindowCount = (int)Form_Global_System.Instance["显示数量"] == null ? 1 : (int)Form_Global_System.Instance["显示数量"];
            }
            catch (Exception)
            {
            ...
            Task.Run(() =>
            {
                Process[] processes = Process.GetProcessesByName("HYProject");
        ...
        private void Button3_Click(object sender, EventArgs e)
        {
            ...
            Form_Product_Set2.Instance.ShowDialog();
        }
        ...
        private void 基准示教ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            Form_Standard form_Standard = new Form_Standard();
            form_Standard.ShowDialog();
        }
        ...
        {
            Work.TCPSocketServer_SocketReceiveMessage3(null, "1212", "&OBG,1,1,52,736,595.894,-84,803\r\\n");
        }

        private void toolStripMenuItem5_Click(object sender, EventArgs e)
        {
            Work.TCPSocketServer_SocketReceiveMessage3(null, "1212", "&OBG,1,2,52,736,595.894,-84,803\\r\\n");
        ...
        {
            Form_General_Parameters.Instance.Form_General_Parameters_Load(sender, e);
            Form_Offset.Instance.Form_Offset_Load(sender, e);
        }
    }
}