    ...
    public partial class Form_Global_System : HYBaseForm
    {
        ...
        private void Form_Global_System_Load(object sender, EventArgs e)
        {
            if (Global_Parameter_System.GetData().Count == 0)
            {
                ...
                Global_Parameter_System.Add("Bool", "Cam1补偿", "true", "Cam1补偿显示状态");
                Global_Parameter_System.Add("Bool", "Cam2补偿", "true", "Cam2补偿显示状态");
                Global_Parameter_System.Add("Bool", "Cam3补偿", "true", "Cam3补偿显示状态");
                Global_Parameter_System.Add("Bool", "Cam1统计", "true", "Cam1统计显示状态");
                Global_Parameter_System.Add("Bool", "Cam2统计", "true", "Cam2统计显示状态");
                Global_Parameter_System.Add("Bool", "Cam3统计", "true", "Cam3统计显示状态");
